...
interface Props {
    announcement: Announcement & { created_by: { id: number; name: string } };
...
const form = useForm({
    ...
    target_roles: props.announcement.target_audience?.roles || [],
    target_departments: props.announcement.target_audience?.department_ids || [],
    target_sub_departments: props.announcement.target_audience?.sub_department_ids || [],
    starts_at: formatDateTime(props.announcement.starts_at),
    expires_at: formatDateTime(props.announcement.expires_at),
        ...
        <div class="flex h-full flex-1 flex-col gap-4 p-4 md:p-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-muted-foreground">Update announcement details</p>
                </div>
            </div>
